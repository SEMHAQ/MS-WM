...
\textbf{MIMO-WM} & 0.51 & \textbf{7.99} & \textbf{0.216} \\
\bottomrule
...
优于Mamba-WM的$20.18\times10^{-2}$、TCN-WM的$20.68\times10^{-2}$和Transformer-WM的$28.11\times10^{-2}$.
值得注意的是, MIMO-WM的参数量仅0.138M, 为所有方法中最轻量, 显著低于Mamba-WM的0.224M.
消融实验表~3进一步证实门控机制是性能提升的关键因素, 移除后MSE增加8.9\%.
MPC实验表~5表明, MIMO-WM的短期预测精度优于Mamba等SSM方法, 为实时规划提供了可靠的动力学校验.
