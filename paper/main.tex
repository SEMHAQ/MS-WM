...
\midrule
\textbf{完整MIMO-WM} & \textbf{18.69$\pm$0.31} & \textbf{0.766} & \textbf{0.138}\\
去门控(w/o-GLU) & 20.36$\pm$0.10 & 0.745 & 0.120\\
$D=64$ & 21.69$\pm$0.35 & 0.729 & 0.089\\
$D=96$ & 19.87$\pm$0.23 & 0.751 & 0.138\\
$D=256$ & 18.15$\pm$0.26 & 0.773 & 0.768\\
$L=1$ & 19.48$\pm$0.21 & 0.756 & 0.083\\
$L=4$ & 18.49$\pm$0.22 & 0.769 & 0.249\\
$N=8$ & 18.77$\pm$0.22 & 0.765 & 0.134\\
\bottomrule
\multicolumn{4}{@{}l@{}}{\fontsize{7pt}{8.5pt}\selectfont 注: $^{\text{a}}$M; 3 seeds; 默认$D{=}96$, $N{=}16$, $L{=}2$.}
\end{tabular}}
\par\endgroup
\end{minipage}

表~3的消融结果表明: 门控机制贡献显著, 移除后MSE增加8.9\%(从18.69增至20.36). 隐空间维度$D$对性能影响最大, $D{=}256$时MSE降至18.15但参数量增至0.768M. 层数$L$和状态维度$N$的影响相对较小, $L{=}4$时MSE降至18.49但参数量翻倍. 默认配置($D{=}96$, $N{=}16$, $L{=}2$)在精度和参数量之间取得较好平衡.
